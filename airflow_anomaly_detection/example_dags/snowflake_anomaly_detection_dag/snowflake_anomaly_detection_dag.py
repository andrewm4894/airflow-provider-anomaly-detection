...
from airflow_anomaly_detection.operators.snowflake.metric_batch_ingest_operator import SnowflakeMetricBatchIngestOperator
...
dag_folder_name = 'snowflake_anomaly_detection_dag'
...
for metric_batch_config_file in metric_batch_configs:
    ...
    def metric_ingestion_dag():
        ...
        metric_batch_ingest = SnowflakeMetricBatchIngestOperator(
